...
--------------------------------------------------------------------------------------------------------------------------
  ...
  Therefore, theoretically, NVS can meet the erasure requirements, but the lifespan of different flash models may vary. It needs to be evaluated based on the actual situation.
