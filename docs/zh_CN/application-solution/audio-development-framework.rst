...
--------------------------------------------------------------------------------------------------
 ...
 - 当前不支持，建议可以考虑使用 dlna , 会有类似的效果。

----------------

ESP32-Korvo-DU1906 board 运行 `korvo_du1906 <https://github.com/espressif/esp-adf/tree/master/examples/korvo_du1906>`_ 示例重启，错误提示如下：Guru Meditation Error: Core  0 panic'ed (IllegalInstruction). Exception was unhandled，如何解决？
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
