...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  若需新增指定型号的摄像头驱动，需由乐鑫内部开展可行性评估。建议先通过 `官网技术咨询 <https://www.espressif.com/zh-hans/contact-us/technical-inquiries>`__ 联系乐鑫工程师，进一步沟通确认需求。当前最新支持政策请参考 `摄像头传感器支持政策 <https://github.com/espressif/esp-video-components/blob/master/esp_cam_sensor/SUPPORT_POLICY_CN.md>`__。
