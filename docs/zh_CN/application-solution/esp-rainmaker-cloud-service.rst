...
---------------------------------------------
  ...
  - `ESP RainMaker 部署资料 <https://docs.rainmaker.espressif.com/zh-Hans/#deployment>`_
...
------------------------------------------------------------------
  ...
  - 如果您想将 ESP RainMaker 部署在自己的 AWS 账号上，首先您需联系 `乐鑫商务 <https://www.espressif.com/zh-hans/contact-us/sales-questions>`_ 以开放相关服务的访问权限，然后可参考 `ESP RainMaker 部署资料 <https://docs.rainmaker.espressif.com/zh-Hans/#deployment>`_ 完成私有化部署。在完成私有化部署后，您将拥有自己的账户体系及管理后台。此时，我们称之为 ESP RainMaker 私有云。
...
-------------------------------------------------------------------------------------------
  ...
  - 不可使用，详细原因请查看 `为什么 Claiming 无法为私有服务器部署？ <https://docs.rainmaker.espressif.com/zh-Hans/docs/deploy/faq-deployment/faq-generic>`_。
