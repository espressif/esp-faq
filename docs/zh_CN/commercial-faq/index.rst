...
-----------------------------------------------------------------------------------------------------------------------
  ...
  乐鑫开发了一套 AT 指令集， 方便客户简单快速地使用 AT 指令来控制芯片。只有少数乐鑫模组（如搭载 ≤ 4MB flash 的 ESP8266 和 ESP32）默认预烧录了 AT 固件，而其他模组默认出厂时为空固件。具体更多信息请联系 `乐鑫商务 <https://www.espressif.com/zh-hans/contact-us/sales-questions>`__ 。我们的工作人员会尽快与您取得联系。
