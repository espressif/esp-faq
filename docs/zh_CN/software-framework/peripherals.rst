...
--------------------------------------------------------------------------------------------------------------------------
  ...
  - 这部分已经在内部开发中，稳定版本预计会随着 IDF v4.4 一起发布。如果想预先完成部分功能验证，可参考 esp-iot-solution 的 `USB 示例程序 <https://github.com/espressif/esp-iot-solution/tree/usb/add_usb_solutions/examples/usb>`_。
...
-------------------------------------------------------------------------------------
  ...
  - ESP32 不支持使用 MCPWM 的 Timer 触发 AD 采样。
