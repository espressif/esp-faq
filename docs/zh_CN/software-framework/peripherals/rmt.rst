...
------------------------------------------------------------------------------
  ...
  - ESP32-S3 可以通过 RMT 外设支持 `One-Wire 总线协议 <https://www.analog.com/cn/resources/technical-articles/guide-to-1wire-communication.html>`_。具体应用可参考 `"esp-idf/examples/peripherals/rmt/onewire" <https://github.com/espressif/esp-idf/tree/release/v5.0/examples/peripherals/rmt/onewire>`_ 例程。
