...
---------------------------------------
  ...
  ESP32 系列芯片 USB 支持情况见 `USB 外设支持情况 <https://docs.espressif.com/projects/esp-iot-solution/zh_CN/latest/usb/usb_overview/usb_overview.html#esp32-s-p-c-usb>`__。
...
----------------------------------------------------------------
  ...
  - 摄像头和麦克风： `usb_camera_mic_spk <https://github.com/espressif/esp-iot-solution/tree/master/examples/usb/host/usb_camera_mic_spk>`__。
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  目前 ESP32-P4 和 ESP32-S31 支持 USB 2.0 高速模式。
...
ESP32-P4 是否可以调整 Serial-JTAG 与 Full-Speed USB 管脚？
---------------------------------------------------------------------------------------------------------------------

  默认情况下，``FS_PHY1`` 连接至 ``USB_SERIAL_JTAG``，``FS_PHY2`` 连接至 ``OTG_FS``。可以通过 ``EFUSE_USB_PHY_SEL`` 更改连接关系。

---------------------------

ESP32-P4 的 High-Speed USB 是否可用于烧录？
---------------------------------------------------------------------------------------------------------------------
